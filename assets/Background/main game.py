...
pygame.display.set_caption("Platformer V. 1.89 BETA")
...
def health(player, objects, to_check):
    player.health = 1
    # work on health maybe 
...
def main(window):
    ...
    player = Player(-1500, 0, 40, 40)
    fire = Fire(100, HEIGHT - block_size - 64, 16, 32)
    fire.on()
    fan = Fan(100, HEIGHT - block_size - 64, 16, 32)
    fan.on()
    ...
    Block(block_size * 33, HEIGHT - block_size * 8, block_size),
    ...
    #Fith/Last stage and ending

    Block(block_size * 95, HEIGHT - block_size * 6, block_size),
    Block(block_size * 94, HEIGHT - block_size * 8, block_size),
    Block(block_size * 94, HEIGHT - block_size * 5, block_size),
    Block(block_size * 93, HEIGHT - block_size * 5, block_size),
    Block(block_size * 92, HEIGHT - block_size * 8, block_size),
    Block(block_size * 92, HEIGHT - block_size * 5, block_size),
    Block(block_size * 91, HEIGHT - block_size * 6, block_size),
    Block(block_size * 87, HEIGHT - block_size * 4, block_size),
    Block(block_size * 87, HEIGHT - block_size * 3, block_size),
    Block(block_size * 87, HEIGHT - block_size * 2, block_size),
    Block(block_size * 87, HEIGHT - block_size * 5, block_size),
    Block(block_size * 81, HEIGHT - block_size * 6, block_size),
    Block(block_size * 75, HEIGHT - block_size * 8, block_size),
    ...
    Block(block_size * 12, HEIGHT - block_size * 10, block_size),
    Block(block_size * 12, HEIGHT - block_size * 9, block_size),
    ...
    #Blocks to not kill yourself/soft lock

    Block(block_size * -17, HEIGHT - block_size * 12, block_size),
    Block(block_size * -17, HEIGHT - block_size * 11, block_size),
    Block(block_size * -17, HEIGHT - block_size * 10, block_size),
    Block(block_size * -17, HEIGHT - block_size * 9, block_size),
    Block(block_size * -17, HEIGHT - block_size * 8, block_size),
    ...
    Block(block_size * -18, HEIGHT - block_size * 11, block_size),
    Block(block_size * -18, HEIGHT - block_size * 10, block_size),
    Block(block_size * -18, HEIGHT - block_size * 9, block_size),
    ...
    Block(block_size * -19, HEIGHT - block_size * 11, block_size),
    Block(block_size * -19, HEIGHT - block_size * 10, block_size),
    Block(block_size * -19, HEIGHT - block_size * 9, block_size),
    ...
    Block(block_size * -20, HEIGHT - block_size * 11, block_size),
    ...
    Block(block_size * -21, HEIGHT - block_size * 11, block_size),
    Block(block_size * -21, HEIGHT - block_size * 10, block_size),
    Block(block_size * -21, HEIGHT - block_size * 9, block_size),
    ...
    Block(block_size * -22, HEIGHT - block_size * 11, block_size),
    Block(block_size * -22, HEIGHT - block_size * 10, block_size),
    Block(block_size * -22, HEIGHT - block_size * 9, block_size),
    Block(block_size * -22, HEIGHT - block_size * 8, block_size),
    ...
    Block(block_size * -23, HEIGHT - block_size * 10, block_size),
    Block(block_size * -23, HEIGHT - block_size * 9, block_size),
    Block(block_size * -23, HEIGHT - block_size * 8, block_size),
    ...
    Block(block_size * -24, HEIGHT - block_size * 12, block_size),
    Block(block_size * -24, HEIGHT - block_size * 11, block_size),
    Block(block_size * -24, HEIGHT - block_size * 10, block_size),
    Block(block_size * -24, HEIGHT - block_size * 9, block_size),
    Block(block_size * -24, HEIGHT - block_size * 8, block_size),
    ...
    #Bottom blocks/Platform at lv1

    Block(block_size * 98, HEIGHT - block_size * 1, block_size),
    Block(block_size * 97, HEIGHT - block_size * 1, block_size),
    Block(block_size * 96, HEIGHT - block_size * 1, block_size),
    Block(block_size * 95, HEIGHT - block_size * 1, block_size),
    Block(block_size * 94, HEIGHT - block_size * 1, block_size),
    Block(block_size * 93, HEIGHT - block_size * 1, block_size),
    Block(block_size * 92, HEIGHT - block_size * 1, block_size),
    Block(block_size * 91, HEIGHT - block_size * 1, block_size),
    Block(block_size * 90, HEIGHT - block_size * 1, block_size),
    Block(block_size * 89, HEIGHT - block_size * 1, block_size),
    Block(block_size * 88, HEIGHT - block_size * 1, block_size),
    Block(block_size * 87, HEIGHT - block_size * 1, block_size),
    Block(block_size * 86, HEIGHT - block_size * 1, block_size),
    Block(block_size * 85, HEIGHT - block_size * 1, block_size),
    Block(block_size * 84, HEIGHT - block_size * 1, block_size),
    ...
    Block(block_size * 77, HEIGHT - block_size * 1, block_size),
    ...
    Block(block_size * 71, HEIGHT - block_size * 1, block_size),
    Block(block_size * 70, HEIGHT - block_size * 1, block_size),
    Block(block_size * 69, HEIGHT - block_size * 1, block_size),
    Block(block_size * 68, HEIGHT - block_size * 1, block_size),
    ...
    Block(block_size * 59, HEIGHT - block_size * 1, block_size),
    Block(block_size * 58, HEIGHT - block_size * 1, block_size),
    Block(block_size * 57, HEIGHT - block_size * 1, block_size),
    Block(block_size * 56, HEIGHT - block_size * 1, block_size),
    Block(block_size * 55, HEIGHT - block_size * 1, block_size),
    Block(block_size * 54, HEIGHT - block_size * 1, block_size),
    ...
    Block(block_size * 44, HEIGHT - block_size * 1, block_size),
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_m:
                    player.jump_count = -999999999999
